...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+10,0,"acc_reg",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+2,(vlSelfRef.a),8);
    bufp->fullCData(oldp+3,(vlSelfRef.b),8);
    bufp->fullIData(oldp+4,(vlSelfRef.out),32);
    bufp->fullBit(oldp+5,(vlSelfRef.mac__DOT__clk));
    bufp->fullBit(oldp+6,(vlSelfRef.mac__DOT__rst));
    bufp->fullCData(oldp+7,(vlSelfRef.mac__DOT__a),8);
    bufp->fullCData(oldp+8,(vlSelfRef.mac__DOT__b),8);
    bufp->fullIData(oldp+9,(vlSelfRef.mac__DOT__out),32);
    bufp->fullIData(oldp+10,(vlSelfRef.mac__DOT__acc_reg),32);
}
