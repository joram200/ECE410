...
wire        ram_rvalid;
wire        ram_rready;
wire  [5:0] kalman_awid;
wire [31:0] kalman_awaddr;
wire  [7:0] kalman_awlen;
wire  [2:0] kalman_awsize;
wire  [1:0] kalman_awburst;
wire        kalman_awlock;
wire  [3:0] kalman_awcache;
wire  [2:0] kalman_awprot;
wire  [3:0] kalman_awregion;
wire  [3:0] kalman_awqos;
wire        kalman_awvalid;
wire        kalman_awready;
wire  [5:0] kalman_arid;
wire [31:0] kalman_araddr;
wire  [7:0] kalman_arlen;
wire  [2:0] kalman_arsize;
wire  [1:0] kalman_arburst;
wire        kalman_arlock;
wire  [3:0] kalman_arcache;
wire  [2:0] kalman_arprot;
wire  [3:0] kalman_arregion;
wire  [3:0] kalman_arqos;
wire        kalman_arvalid;
wire        kalman_arready;
wire [63:0] kalman_wdata;
wire  [7:0] kalman_wstrb;
wire        kalman_wlast;
wire        kalman_wvalid;
wire        kalman_wready;
wire  [5:0] kalman_bid;
wire  [1:0] kalman_bresp;
wire        kalman_bvalid;
wire        kalman_bready;
wire  [5:0] kalman_rid;
wire [63:0] kalman_rdata;
wire  [1:0] kalman_rresp;
wire        kalman_rlast;
wire        kalman_rvalid;
wire        kalman_rready;
...
axi_intercon axi_intercon
   (.clk_i          (clk),
    ...
    .o_kalman_awid      (kalman_awid),
    .o_kalman_awaddr    (kalman_awaddr),
    .o_kalman_awlen     (kalman_awlen),
    .o_kalman_awsize    (kalman_awsize),
    .o_kalman_awburst   (kalman_awburst),
    .o_kalman_awlock    (kalman_awlock),
    .o_kalman_awcache   (kalman_awcache),
    .o_kalman_awprot    (kalman_awprot),
    .o_kalman_awregion  (kalman_awregion),
    .o_kalman_awqos     (kalman_awqos),
    .o_kalman_awvalid   (kalman_awvalid),
    .i_kalman_awready   (kalman_awready),
    .o_kalman_arid      (kalman_arid),
    .o_kalman_araddr    (kalman_araddr),
    .o_kalman_arlen     (kalman_arlen),
    .o_kalman_arsize    (kalman_arsize),
    .o_kalman_arburst   (kalman_arburst),
    .o_kalman_arlock    (kalman_arlock),
    .o_kalman_arcache   (kalman_arcache),
    .o_kalman_arprot    (kalman_arprot),
    .o_kalman_arregion  (kalman_arregion),
    .o_kalman_arqos     (kalman_arqos),
    .o_kalman_arvalid   (kalman_arvalid),
    .i_kalman_arready   (kalman_arready),
    .o_kalman_wdata     (kalman_wdata),
    .o_kalman_wstrb     (kalman_wstrb),
    .o_kalman_wlast     (kalman_wlast),
    .o_kalman_wvalid    (kalman_wvalid),
    .i_kalman_wready    (kalman_wready),
    .i_kalman_bid       (kalman_bid),
    .i_kalman_bresp     (kalman_bresp),
    .i_kalman_bvalid    (kalman_bvalid),
    .o_kalman_bready    (kalman_bready),
    .i_kalman_rid       (kalman_rid),
    .i_kalman_rdata     (kalman_rdata),
    .i_kalman_rresp     (kalman_rresp),
    .i_kalman_rlast     (kalman_rlast),
    .i_kalman_rvalid    (kalman_rvalid),
    .o_kalman_rready    (kalman_rready));
