...
set genomeRtd $env(RT_TMP)/3233E7C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {kalman_update__GCB0}]"
...
set genomeName [subst -nocommands -novariables {kalman_update__GCB0}]
