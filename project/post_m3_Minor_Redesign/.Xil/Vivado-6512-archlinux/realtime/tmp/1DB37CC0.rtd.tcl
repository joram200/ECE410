...
set genomeRtd $env(RT_TMP)/1DB37CC0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gemm_systolic__GB0}]"
...
set genomeName [subst -nocommands -novariables {gemm_systolic__GB0}]
