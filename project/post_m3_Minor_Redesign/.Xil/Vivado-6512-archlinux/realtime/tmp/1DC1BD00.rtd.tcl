...
set genomeRtd $env(RT_TMP)/1DC1BD00.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {kalman_update__GCB1}]"
...
set genomeName [subst -nocommands -novariables {kalman_update__GCB1}]
